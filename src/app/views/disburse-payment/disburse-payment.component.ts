...
@Component({
    selector: 'app-main-disburse-payment',
    templateUrl: 'disburse-payment.component.html',
    styleUrls: ['disburse-payment.component.scss']
})
export class DisbursePaymentComponent implements OnInit {
    ...
    disburseTransactionList: Array<any> = [];
    ...
    getTransactionList() {
        ...
        this._service.get('disbursed-transaction-list', params).subscribe(res => {
            this.disburseTransactionList = res.data;
        }, err => { }
        );
    }
    ...
    editItem(item){
        this.modalTitle = 'Update Disbursement';
